const i18n = {
  'en-US': {
    ...
    'searchTable.operations.genDatabaseDoc': 'generate Database Doc',
  ...
  'zh-CN': {
    ...
    'searchTable.operations.genDatabaseDoc': '生成数据库文档',
