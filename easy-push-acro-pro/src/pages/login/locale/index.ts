const i18n = {
  ...
  'zh-CN': {
    ...
    'login.form.loginType.placeholder': '请选择登录方式',
    'login.form.userName.placeholder': '用户名/邮箱',
    'login.form.password.placeholder': '密码/密钥/验证码',
    'login.form.rememberPassword': '记住密码',
    'login.form.sendmail': '发送验证码',
    'login.form.login': '登录',
