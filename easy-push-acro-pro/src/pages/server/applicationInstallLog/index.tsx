...
import { managerPage, removeRequest } from '@/api/applicationInstallLog';
import { SorterResult } from '@arco-design/web-react/es/Table/interface';
import InstallLogInfoPage from './logInfo';
  ...
  return (
    <Card>
      ...
      <Table
        ...
        data={data}
      />
      <InstallLogInfoPage  logId={viewLogId} visible={isViewLog} setVisible={setIsViewLog}/>
    </Card>
  );
}
