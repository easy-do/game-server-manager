const i18n = {
  'en-US': {
    ...
    'searchTable.columns.operations.updateScript': 'Edit Script',
  ...
  'zh-CN': {
    ...
    'searchTable.columns.operations.updateScript': '编辑脚本',
    ...
    'searchTable.columns.EnvInfo': '脚本变量',
    'searchTable.columns.envName': '变量名',
    'searchTable.columns.envKey': '变量key',
    'searchTable.columns.envValue': '变量默认值',
    'searchTable.columns.envDescription': '提示',
    ...
    'searchTable.rules.envDescription.required': '提示不能为空',
