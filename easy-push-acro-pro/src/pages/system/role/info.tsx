...
import { infoRequest } from '@/api/role';
  ...
  const data = [
    {
      ...
      value: loading? <Skeleton text={{ rows: 1, style: { width: '200px' } }} animation /> : infoData? infoData.roleId:'',
    },
    {
      label: t['searchTable.columns.roleName'],
      value: loading? <Skeleton text={{ rows: 1, style: { width: '200px' } }} animation /> : infoData? infoData.roleName:'',
    },
    {
      label: t['searchTable.columns.roleKey'],
      value: loading? <Skeleton text={{ rows: 1, style: { width: '200px' } }} animation /> : infoData? infoData.roleKey:'',
    },
    {
      label: t['searchTable.columns.roleSort'],
      value: loading? <Skeleton text={{ rows: 1, style: { width: '200px' } }} animation /> : infoData? infoData.roleSort:'',
    },
    {
