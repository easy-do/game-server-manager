...
import { infoRequest } from '@/api/notice';
...
function InfoPage(props: {id:number,visible,setVisible}) {
  ...
  const data = [
    ...
    // },
    {
      ...
      value: loading? <Skeleton text={{ rows: 1, style: { width: '200px' } }} animation /> : infoData? <MarkdownEditor value={infoData.noticeContent} previewOnly={true}/>:'',
    },
  ];
  ...
  return (
    <Modal
      ...
      title={infoData?infoData.noticeTitle:''}
