...
import plus.easydo.server.config.oss.minio.config.MinioProperties;
import io.minio.*;
...
@EnableConfigurationProperties(plus.easydo.server.config.oss.minio.config.MinioProperties.class)
