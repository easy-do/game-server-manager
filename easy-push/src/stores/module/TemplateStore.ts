...
import { add, edit, info, list, page, remove } from '../../api/template';
...
class TemplateStore {
  ...
  /**点击更新确认按钮 */
  editDataOk = () => {
    this.dataInfo.templateCode = null
  ...
  /**点击编写模板按钮 */
  onClickEditTemplateButton = (id: object, event: any) => {
    this.dataInfoRequest(id, 'editTemplate')
  }


  /**点击编写模板确认按钮 */
  editTemplateOk = (value: string) => {
    this.dataInfo.templateCode = value
    this.editDataRequest(this.dataInfo)
  }
