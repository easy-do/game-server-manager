package plus.easydo.dao.result;
...
public class MpResultUtil {
    ...
    public static <T> MpDataResult buildPageData( List<T> list,Long total) {
        MpDataResult dataResult = new MpDataResult();
        dataResult.setTotal(total);
        dataResult.setCount(total);
        dataResult.setData(list);
    ...
    public static <T> MpDataResult buildPage(SearchResult<T> searchResult) {
        return buildPageData(searchResult.getDataList(), (Long) searchResult.getTotalCount());
    }

    public static <T> MpDataResult buildPage(List<T> data,Long total) {
        return buildPageData(data, total);
    }
